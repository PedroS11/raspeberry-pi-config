...
The script will keep the last two updates in the HDD (defined by `MAX_LOCAL_BACKUPS`) and in Google Drive (defined by `MAX_DRIVE_BACKUPS`). To save space, the img file is compressed.
